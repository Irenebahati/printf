...
return (handleWriteChar_func(c, buffer, flags, width, precision, size));
}
/************************* PRINT A STRING *************************/
/**
* printString_func - Prints a string
* @types: List a of arguments
* @buffer: Buffer array to handle print
* @flags:  Calculates active flags
* @width: get width.
...
/************************* OUTPUT PERCENT SIGN *************************/
/**
* printPercent_func - Prints a percent sign
...
n = convertSizeNumber_func(n, size);
...
/************************* OUTPUT BINARY *************************/
/**
* printBinary_func - Prints an unsigned number
* @types: Lista of arguments
* @buffer: Buffer array to handle print
* @flags:  Calculates active flags
* @width: get width.
